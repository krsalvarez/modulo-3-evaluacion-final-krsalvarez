...
return (
    <div className="input">
        ...
        <input type="radio" id="human" name="specie" value="Human" onChange={handleChange} className="filter-radio" />
        <label htmlFor="alien" className="filter-specie">Alien</label>
        <input type="radio" id="alien" name="specie" value="Alien" onChange={handleChange} className="filter-radio" />
    </div>
    )
}
